...
<h3>ENTER YOUR NAME : TEJASWINI G </h3>
<h3>ENTER YOUR REGISTER NO: 212222230157 </h3>
<h3>EX. NO 3 </h3>
<h3>DATE</h3>
...
int main() {
    ...
    imwrite("output_sobel_opencv.jpg", opencvOutput);
...
## OUTPUT:
## ORIGINAL:
![image](https://github.com/user-attachments/assets/5ba3129c-7d7b-4cde-8a2f-28ccd213d702)

## OUTPUT:
![image](https://github.com/user-attachments/assets/7dfd053a-7e60-465c-a9aa-8a13ab4a1d31)
...
2. Smaller block sizes (e.g., 8x8) were efficient for smaller images but less so for larger ones, where larger blocks (e.g., 32x32) reduced overhead.
CUDA vs. CPU Output Differences:

3. The CUDA implementation was faster, with minor variations in edge sharpness due to rounding differences. CPU output took significantly more time than the GPU.
Optimization Suggestions:

4. Use shared memory in the CUDA kernel to reduce global memory access times.
